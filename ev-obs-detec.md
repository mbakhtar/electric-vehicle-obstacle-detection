# Electric Vehicle Prototype - Obstacle Detection
```package
fwd-edu-breakout=github:climate-action-kits/pxt-fwd-edu/fwd-breakout
sonar=github:climate-action-kits/pxt-fwd-edu
```
## Step 1 @showdialog
Welcome to Electric Vehicle Coding Tutorial - Obstacle Detection
...
Congratulations on completing your Electric Vehicle Prototype for Obstacle Detection! - Go back to the lesson for more activities and extensions.